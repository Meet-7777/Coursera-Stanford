...
two_sum_finder = TwoSumFinder("input.txt")

# Call the compute_values() method to find the number of distinct target values
result = two_sum_finder.compute_values()

# Print the result
print("Number of distinct target values:", result)